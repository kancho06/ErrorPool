...
public class MyPageController {
    ...
    @GetMapping("/article")
    public Page<Article> getArticles(@ApiIgnore @AuthenticationPrincipal UserDetailsImpl userDetails) {
        return articleService.getArticles(userDetails.getUser());
    }

    @ApiOperation(value = "내 댓글 조회")
    @GetMapping("/comment")
    public Page<Comment> getComments(@ApiIgnore @AuthenticationPrincipal UserDetailsImpl userDetails) {
